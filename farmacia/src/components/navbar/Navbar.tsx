                ...
                <div className="relative flex flex-1 justify-center items-center w-30 text-black">
                    <form className="flex justify-center w-3/4">
                        <input className="px-4 py-4 rounded-lg w-10/12 h-9 focus:outline-none"
                            ...
                            required
                        />
                        <button type="submit" className="bg-customBlue hover:bg-blue-400 p-2.5 border border-bg-customBlue rounded-lg focus:ring-4 focus:ring-blue-300 dark:focus:ring-teal-800 w-9 h-9 font-medium text-sm text-white ms-2 focus:outline-none">
